...
summon creeper -20 40.7 199.8 {Invulnerable: 1, PersistenceRequired: 1, Silent: 1, NoAI: 1, Rotation: [0f, -90f], Tags: ["s4"]}
summon creeper -33.4 43.25 199 {Invulnerable: 1, PersistenceRequired: 1, Silent: 1, NoAI: 1, Rotation: [-90f, -90f], Tags: ["s4"]}
